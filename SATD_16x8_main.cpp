...
UINT SATD_16x8_intr( unsigned char *address1, unsigned int stride1, unsigned char *address2, unsigned int stride2 )
{
...
UINT SATD_16x8_yasm( unsigned char *address1, unsigned int stride1, unsigned char *address2, unsigned int stride2 )
{
	UINT ret = satd_4x4_sse3_YASM( address1, stride1, address2, stride2 );
	ret += satd_4x4_sse3_YASM( address1 + 8, stride1, address2 + 4, stride2 );
...
UINT SATD_16x8_yasm2( unsigned char *address1, unsigned int stride1, unsigned char *address2, unsigned int stride2 )
{
	UINT ret = satd_8x8_sse3_YASM( address1, stride1, address2, stride2 );
	ret += satd_8x8_sse3_YASM( address1 + 8, stride1, address2 + 8, stride2 );
	return ret;
}
...
//		functions[1] = satd_16x16_sse4_YASM;
	...
	{
		functions[0] = SATD_16x8_intr;
		functions[1] = SATD_16x8_yasm2;
	}
	else
	{
